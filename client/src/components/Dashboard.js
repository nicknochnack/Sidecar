...
import EnvironmentConnections from "./dashboard/EnvironmentConnections";
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-neutral-600 dark:text-neutral-400 text-lg">
          Your Watson Orchestrate development companion
        </p>
      </div>
      ...
      {/* Environment Connections & Activity Heatmap */}
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-600 dark:text-neutral-400">
                  Register your agent in watsonx Orchestrate via the integration
                  wizard
                </p>
              </div>
            </div>
